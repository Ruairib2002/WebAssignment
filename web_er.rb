...
graph.add_nodes("Users", label: "Users\nuser_id (PK)\nfull_name\nemail\nrole_id (FK)\nbio\nprofile_picture (FK to ActiveStorageAttachments)")
...
graph.add_edges("Submissions", "Users", label: "submitted by")
graph.add_edges("Files", "Users", label: "uploaded by")
graph.add_edges("Messages", "Users", label: "posted by")
graph.add_edges("Messages", "Groups", label: "belongs to")
...
graph.add_edges("ActiveStorageAttachments", "ActiveStorageBlobs", label: "attached to")
graph.add_edges("ActiveStorageVariantRecords", "ActiveStorageBlobs", label: "variant of")
graph.add_edges("Users", "ActiveStorageAttachments", label: "has profile_picture")
