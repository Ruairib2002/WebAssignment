...
^X Exit      ^J Justify   ^W Where is  ^V Next Pg   ^U UnCut Text^T To Spell
  UW PICO 5.09                  File: updated_er_diagram.rb
...
graph.add_edges("ActiveStorageAttachments", "ActiveStorageBlobs", label: "has blob", dir: :forward)
...
output_path = File.expand_path("~/Desktop/Updated_ER_Diagram.png")
